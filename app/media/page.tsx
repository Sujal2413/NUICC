...
import { LaunchesGrid, PressList } from "@/components/ui/nuicc-media";

export const metadata: Metadata = {
  title: "Media Center — Launches & Press | NUICC",
  description:
    "NUICC in the news: regional chapter launches, diplomatic engagements, and press coverage across U.S. and Indian media outlets.",
};
    ...
    <main className="relative min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <section className="mx-auto w-full max-w-6xl px-4 pt-28 md:pt-36">
        ...
        <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
          New regional chapters, diplomatic engagements, and press coverage across both
          countries.
        </p>
      </section>
