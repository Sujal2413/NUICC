...
function toggleInlineText(btn) {
        const moreText = btn.previousElementSibling.querySelector(".nuicc-vm-more");
        moreText.classList.toggle("show");
        btn.innerText = moreText.classList.contains("show") ? "View Less" : "View More";
    }
